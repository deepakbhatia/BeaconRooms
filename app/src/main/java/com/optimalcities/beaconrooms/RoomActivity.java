...
/**
 * Created by obelix on 15/01/2017.
 */
...
public class RoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = intent.getStringExtra("room_url");
    ...
    private void connectToRoom(String roomName) {
        ...
        Toast.makeText(this,roomName,Toast.LENGTH_LONG).show();
        setAudioFocus(true);
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnectFailure(Room room, TwilioException e) {
                videoStatusTextView.setText("Failed to connect:"+e.message);
            }
    ...
    private void retrieveAccessTokenfromServer() {
        Ion.with(this)
                .load("https://3-dot-webrooms-155621.appspot.com/token")
                .asJsonObject()
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if (e == null) {
                            ...
                            videoClient = new VideoClient(RoomActivity.this, accessToken);
