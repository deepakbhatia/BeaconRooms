...
/**
 * Created by obelix on 14/01/2017.
 */
...
public class Dialog {
    ...
    public static AlertDialog createConnectVideoDialog(TextView roomTextView, String roomName, DialogInterface.OnClickListener callParticipantsClickListener, DialogInterface.OnClickListener cancelClickListener, Context context) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
        ...
        alertDialogBuilder.setView(roomTextView, horizontalPadding, verticalPadding, horizontalPadding, 0);
